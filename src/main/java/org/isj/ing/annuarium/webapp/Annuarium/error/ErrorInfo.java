...
public enum ErrorInfo {
    ...
    COMMANDE_NOT_FOUND("#COMMANDE_NOT_FOUND", Status.NOT_FOUND),
    COMMANDE_PRODUIT_NOT_FOUND("#COMMANDE_PRODUIT_NOT_FOUND", Status.NOT_FOUND),
    LIVRAISON_NOT_FOUND("#LIVRAISON_NOT_FOUND", Status.NOT_FOUND),
    CUSTOMER_NOT_FOUND("#CUSTOMER_NOT_FOUND", Status.NOT_FOUND);
