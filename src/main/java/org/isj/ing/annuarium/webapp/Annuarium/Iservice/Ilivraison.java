...
public interface Ilivraison {
    Livraison saveLivraison(Livraison liv, Commandeproduit cmdPrd)throws isjException;
    Livraison updateLivraison(Integer id,Livraison liv) throws isjException;
